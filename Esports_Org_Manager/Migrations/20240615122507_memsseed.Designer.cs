...
namespace Esports_Org_Manager.Migrations
{
    ...
    [Migration("20240615122507_memsseed")]
    partial class memsseed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Esports_Org_Manager.Models.MembershipModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            startDate = new DateTime(2020, 12, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            teamId = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Esports_Org_Manager.Models.TeamTourneyModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            awardPool = 200000.0,
                            date = new DateTime(2024, 5, 26, 14, 25, 5, 1, DateTimeKind.Local).AddTicks(9713),
                            format = "NFL",
